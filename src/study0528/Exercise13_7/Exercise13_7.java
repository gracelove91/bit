package study0528.Exercise13_7;
...
public class Exercise13_7 extends Frame implements MouseListener {
	...
	public void mousePressed(MouseEvent e) {
		...
		//x와 y의 값이 오폭판의 밖을 벗어난 곳이면 돌을 그리지 않는다.
//		if(x ) return;
//		System.out.println(FRAME_WIDTH + BOARD_SIZE);
//		System.out.println(FRAME_HEIGHT + BOARD_SIZE);
		System.out.println("Y0 = " +Y0);
		if(x < X0) {
			System.out.println("x축 미만요.");
//			return;
		}
		if(x > (LINE_WIDTH * LINE_NUM - 1)) {
			System.out.println("x축 초과요.");
			return;
		}
		
//		if(y < Y0) {
//			System.out.println("y축 미만요.");
//		}
//		
//		if(y > (LINE_WIDTH * LINE_NUM - 1) + Y0) {
//			System.out.println("y축 초과요.");
//		}
		
//		if(y < Y0 || y > (Y0 * (LINE_NUM))) {
//			System.out.println("야야야야야야야 y도 넘어갔");
//			return;
//		}
